...
const navItems = [
  ...
  { icon: UtensilsCrossed, label: "Food & Mess", path: "/food" },
  { icon: MapPin, label: "Tracking", path: "/tracking" },
  { icon: Heart, label: "Roommates", path: "/roommates" },
];
        ...
        <div className="border-t border-sidebar-border p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-sidebar-foreground truncate">Warden Admin</p>
              <p className="text-xs text-sidebar-muted truncate">Block A</p>
            </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between border-b border-border bg-card px-4 lg:px-8">
          ...
          <div className="lg:hidden">
            <AbodeLogo size={24} showText={false} />
          </div>
